...
const didClickRegister = async (e) => {
    ...
    publicKeyCredentialCreateOptions = transformCredentialCreateOptions(credentialCreateOptionsFromServer);
    publicKeyCredentialCreateOptions.extensions.credBlob = new TextEncoder().encode("test");
